          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl">
                Search and register your ideal domain name instantly. Secure your online identity with our comprehensive domain registration services.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-8">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">500+ TLDs</span>
              </div>
              <div className="flex items-center gap-2">
                <Shield className="h-5 w-5 text-primary" />
                <span className="text-sm font-medium">WHOIS Privacy</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="relative z-10">
              ...
              <div className="bg-card border rounded-lg shadow-2xl p-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-3 bg-muted rounded">
                      <span className="text-sm">mywebsite.net</span>
                      <Badge variant="default" className="bg-green-500">Available</Badge>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-muted rounded">
                      <span className="text-sm">mywebsite.org</span>
                      <Badge variant="default" className="bg-green-500">Available</Badge>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-muted rounded">
                      <span className="text-sm">mywebsite.io</span>
                      <Badge variant="default" className="bg-green-500">Available</Badge>
                    </div>
                  </div>
                </div>
              ...
              <div className="absolute -bottom-4 -left-4 bg-secondary text-secondary-foreground p-3 rounded-lg shadow-lg">
                <div className="text-center">
                  ...
                  <div className="text-xs">TLDs</div>
                </div>
              </div>
            </div>
