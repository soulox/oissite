...
export function EmailServiceHero() {
  return (
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl">
                Get professional email hosting with your domain. Spam protection, mobile sync, and business-grade features.
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" asChild>
                <Link href="#email-plans">
                  View Email Plans
                </Link>
              </Button>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">Mobile Sync</span>
              </div>
            </div>
          </div>
              ...
              <div className="bg-card border rounded-lg shadow-2xl p-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="font-semibold">Email Dashboard</h3>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-muted rounded">
                      ...
                      <Badge variant="default" className="bg-green-500">5 Active</Badge>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-muted rounded">
                      <span className="text-sm">Storage Used</span>
                      <span className="text-sm font-semibold">2.5 GB / 10 GB</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-muted rounded">
