...
export function SharedHostingHero() {
  return (
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl">
                Perfect for personal websites, blogs, and small businesses. Get reliable hosting with all the features you need to succeed online.
              </p>
            </div>
            ...
            <div className="relative z-10">
              ...
              <div className="bg-card border rounded-lg shadow-2xl p-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="font-semibold">Shared Hosting Dashboard</h3>
              ...
              <div className="absolute -bottom-4 -left-4 bg-secondary text-secondary-foreground p-3 rounded-lg shadow-lg">
                <div className="text-center">
                  ...
                  <div className="text-xs">Day Guarantee</div>
                </div>
              </div>
            </div>
